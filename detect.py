...
from extracting_text import extract_img
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/custom_dataset.yaml',help='(optional) dataset.yaml path')
